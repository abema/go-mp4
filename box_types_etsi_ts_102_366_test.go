...
func TestBoxTypesETSI_TS_102_366(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			dst: &Dec3{},
			bin: []byte{0xff, 0xf9, 0xfe, 0xff, 0x1f, 0xff, 0xfe, 0xff, 0x1},
			str: `DataRate=8191 NumIndSub=0x1 IndSubs=[{Fscod=0x3 Bsid=0x1f Asvc=0x1 Bsmod=0x7 Acmod=0x7 LfeOn=0x1 NumDepSub=0xf ChanLoc=511}, {Fscod=0x3 Bsid=0x1f Asvc=0x1 Bsmod=0x7 Acmod=0x7 LfeOn=0x1 NumDepSub=0x0}]`,
		},
	}
